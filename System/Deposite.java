        ...
        try 
        {
            ...
            if(ae.getSource()==b1)
            {
                ...
                else
                {
                    ...
                    double d=Double.parseDouble(depositamount); //this is convert String Object to Pimitive data type "Double"....
                    balance=balance+d;

                    String q2="Insert into bank values('"+pinno+"','"+date+"','Deposit Rs."+depositamount+"','"+balance+"')";
